                        ...
                        .init(
                            route: Tradewinds.Route<TradewindsLegendNode, LegendRouteType>(
                                ...
                                sink: .tokenBalance(
                                    ...
                                    address: EthAddress(
                                        "0x4200000000000000000000000000000000000006"
                                    ).on(Eth.Network.worldChain),  // WETH on WorldChain
                                    symbol: "WETH",
                                    wallet: EthAddress("0x00000000000000000000000000000000000a11ce").on(Eth.Network.worldChain)
                                ),
                                rate: .one,
                                minFlow: "0",
                                maxFlow: Number.MAX_UINT_256
                    ...
                    [
                        .init(
                            route: Tradewinds.Route<TradewindsLegendNode, LegendRouteType>(
                                ...
                                source: .tokenBalance(
                                    network: Eth.Network.arbitrum,
                                    address: ArbitrumNetwork.Assets.ETH.assetAddress.on(Eth.Network.arbitrum),
                                    symbol: "ETH",
                                    wallet: EthAddress("0x00000000000000000000000000000000000a11ce").on(Eth.Network.arbitrum)
                                ),
                                sink: .tokenBalance(
                        ...
                        .init(
                            route: Tradewinds.Route<TradewindsLegendNode, LegendRouteType>(
                                ...
                                rate: Percentage(fromDouble: 0.99),  // 1% fee
                                fees: [
                                    Tradewinds.Fee(type: .bridgeAcross, isInFee: false, amount: "1e16")  // 0.01 WETH minimum
                                ],
                                minFlow: "0",
                                maxFlow: Number.MAX_UINT_256
                            ),
